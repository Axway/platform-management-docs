...
| Role                       | Short Description                                                                                                                                                                                | Platform | App Dev | App Integration | Central | Catalog | ARS | MBaaS | Teams | Audit | Flow Manager |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ------- | --------------- | ------- | ------- | --- | ----- | ----- | ----- | ------------ |
| **Platform Roles**         |                                                                                                                                                                                                  |          |         |                 |         |         |     |       |       |       |              |
...
| **Marketplace**                         |                         |                         |                         |                    |                         |
| View subscriptions                      |                         | x (my team assets)      |                         |                    |                         |
| Edit subscriptions                      |                         | x (my team assets)      |                         |                    |                         |
| Delete subscriptions                    |                         | x (my team assets)      |                         |                    |                         |
| View subscriptions usage                |                         | x (my team assets)      |                         |                    |                         |
| **Environments**                        |                         |                         |                         |                    |                         |
| Create environments                     |                         |                         |                         |                    |                         |
| View environments                       |                         |                         |                         |                    |                         |
| Delete environments                     |                         |                         |                         |                    |                         |
