...
| Role Type / Scope                 | Catalog Manager   | Developer     |Team Manager|Subscription Approver|Marketplace Manager|Insights Viewer|Environment Manager<br/>**Coming soon**|API Access Manager|
|-----------------------------------|-------------------|---------------|------------|---------------------|-------------------|---------------|---------------------------------------|------------------|
| **Team and Members**              |                   |               |            |                     |                   |               |                                       |                  |
| Create a team                     |                   |               |            |                     |                   |               |                                       |                  |
...
| View subscriptions                |                   |               |            | x (owned products)  |                   |               |                                       |                  |
