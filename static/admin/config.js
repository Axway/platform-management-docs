 ...
 */
 const collections = [{
  ...
  ...docsDefaults('management_guide/overview', 'management_guide'),
  name: 'the_dashboards',
  ...
  ...docsDefaults('management_guide/managing_applications', 'managing_applications'),
  ...
  ...docsDefaults('management_guide/managing_applications/managing_client_applications', 'managing_client_applications'),
  ...
  ...docsDefaults('management_guide/managing_applications/managing_mobile_backend_services_datasources', 'managing_mobile_backend_services_datasources'),
  ...
  ...docsDefaults('management_guide/managing_applications/managing_mobile_backend_services_datasources/managing_mobile_backend_services_data_objects', 'managing_mobile_backend_services_data_objects'),
